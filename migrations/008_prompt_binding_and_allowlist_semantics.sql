...
-- Note: SQLite doesn't support DROP COLUMN, so we can't remove prompt_type/prompt_version
-- This is acceptable as the columns are nullable and won't affect older code
