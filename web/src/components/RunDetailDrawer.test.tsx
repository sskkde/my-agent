...
const mockConsoleData = {
  ...
  audit: [
    { auditId: 'a1', action: 'created', timestamp: '2024-01-15T10:00:00Z' },
  ],
};
...
describe('RunDetailDrawer', () => {
  ...
  it('does not render when closed', () => {
    render(
      <RunDetailDrawer runId="run-123" isOpen={false} onClose={() => {}} />
    );
  ...
  it('renders when open', () => {
    ...
    render(
      <RunDetailDrawer runId="run-123" isOpen onClose={() => {}} />
    );
  ...
  it('calls onClose when close button is clicked', async () => {
    ...
    render(
      <RunDetailDrawer runId="run-123" isOpen onClose={handleClose} />
    );
