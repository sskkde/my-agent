...
describe('ComposerDock', () => {
  ...
  describe('Send Behavior', () => {
    it('calls onSend when send button is clicked with valid message', () => {
      render(
        <ComposerDock value="Hello world" onChange={mockOnChange} onSend={mockOnSend} />
      );
  ...
  describe('Input Change', () => {
    ...
    it('displays current value in textarea', () => {
      render(
        <ComposerDock value="Test message" onChange={mockOnChange} onSend={mockOnSend} />
      );
  ...
  describe('Sending State', () => {
    ...
    it('displays "发送" when not sending', () => {
      render(
        <ComposerDock value="Hello" onChange={mockOnChange} onSend={mockOnSend} />
      );
