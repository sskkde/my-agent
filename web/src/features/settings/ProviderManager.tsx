...
const ProviderManager: React.FC<ProviderManagerProps> = ({ isAuthenticated }) => {
  ...
  const validateForm = (): boolean => {
    ...
    if (requiresBaseUrl(formData.providerType) && !formData.baseUrl.trim()) {
      errors.baseUrl = formData.providerType === 'custom'
        ? '自定义提供商需要指定 Base URL'
        : 'Ollama 需要指定 Base URL';
    }
                    ...
                    <div className="provider-card-details">
                      ...
                      {provider.apiKeyLast4 && (
                        <div className="provider-detail">
                          ...
                          <span className="detail-value api-key-mask">
                            ****{provider.apiKeyLast4}
                          </span>
                        </div>
                      )}
                      ...
                      <div className="provider-detail">
                        ...
                        <span
                          className={`detail-value test-status ${getLastTestStatusClass(
                    ...
                    {testResult?.providerId === provider.providerId && (
                      <div
                        className={`test-result ${
                          testResult.result.success ? 'test-success' : 'test-failed'
                        }`}
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit} className="provider-form">
              <div className="form-group">
                ...
                {editingProvider && (
                  <span className="form-hint">提供商类型不可修改</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder={
                    editingProvider ? '留空以保持当前密钥' : '输入您的 API Key'
                  }
                ...
                {editingProvider && (
                  <span className="form-hint">留空以保持当前密钥不变</span>
                )}
                {formData.providerType === 'ollama' && (
                  <span className="form-hint">Ollama 本地部署不需要 API Key</span>
                )}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, selectedModel: e.target.value }))
                  }
              ...
              {formErrors.submit && (
                <div className="form-submit-error">{formErrors.submit}</div>
              )}
