...
describe('TriggerCreateDialog', () => {
  ...
  const mockWorkflows = [
    { workflowId: 'wf-1', name: 'Workflow 1', version: 1, steps: [], ownerUserId: 'user-1', status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
    { workflowId: 'wf-2', name: 'Workflow 2', version: 1, steps: [], ownerUserId: 'user-1', status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  ];
