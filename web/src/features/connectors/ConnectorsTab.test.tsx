...
describe('ConnectorsTab', () => {
  ...
  it('shows loading state', async () => {
    vi.mocked(connectorsApi.getConnectors).mockImplementation(() => new Promise(() => undefined))
  ...
  it('updates instance config on button click', async () => {
    ...
    await waitFor(() => {
      expect(connectorsApi.updateInstanceConfig).toHaveBeenCalledWith('conn-1', 'inst-1', { newKey: 'newValue' })
    })
    await waitFor(() => {
