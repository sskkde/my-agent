...
const ObservabilityTab: React.FC = () => {
  ...
  const handleRunClick = async (runId: string) => {
    ...
    setExpandedRuns(new Map(expandedRuns).set(runId, {
      id: runId,
      console: null,
      loading: true,
      error: null,
  ...
  const renderPreviewModal = () => {
    ...
    return (
      <div className="observability-modal-overlay" onClick={closePreview}>
        <div 
          className="observability-modal" 
          onClick={(e) => e.stopPropagation()}
          data-testid="replay-preview-modal"
        >
            ...
            return (
              <div key={run.id} className="observability-run-item">
                ...
                >
                  ...
                  {run.summary && (
                    <div className="observability-run-summary">{run.summary}</div>
                  )}
                </div>
