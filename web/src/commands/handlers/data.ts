...
import { getSkills, getUsage, getSessionUsage, getLogs, getDebugReplay, getTranscripts } from '../../api/client.js'
...
export const handleLogs: CommandHandler = async (
  ...
  try {
    const sessionId = typeof flags.session === 'string' ? flags.session : context.sessionId || undefined
