...
import { CommandRegistry, createRegistry, DuplicateCommandError, CommandRegistryError } from '../registry.js'
import type { FrontendCommandDefinition, FrontendCommandResult } from '../types.js'
...
const createMockCommand = (name: string, aliases?: string[]): FrontendCommandDefinition => ({
...
describe('CommandRegistry', () => {
  ...
  describe('register', () => {
    ...
    it('should throw DuplicateCommandError for duplicate command', () => {
      ...
      expect(() => registry.register(cmd, mockHandler)).toThrow(DuplicateCommandError)
    })
    ...
    it('should throw DuplicateCommandError for duplicate alias', () => {
      ...
      expect(() => registry.register(cmd2, mockHandler)).toThrow(DuplicateCommandError)
    })
  ...
  describe('registerCatalog', () => {
    ...
    it('should throw error if handler missing', () => {
      ...
      expect(() => registry.registerCatalog(catalog, handlers)).toThrow(CommandRegistryError)
    })
  })
