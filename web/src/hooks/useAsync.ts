 ...
 */
export function useAsync<T>(asyncFn: () => Promise<T>, initialData: T | null = null): UseAsyncReturn<T> {
 ...
 */
export function useFetch<T>(fetchFn: () => Promise<T>, initialData: T | null = null): UseAsyncReturn<T> {
