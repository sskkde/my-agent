...
export const API_ROUTE_DEFINITIONS: ApiRouteDefinition[] = [
  ...
  { path: '/api/v1/debug/events', methods: ['GET'] },
  ...
  { path: '/api/v1/files/:fileId', methods: ['DELETE', 'GET'] },
  { path: '/api/v1/files/:fileId/download', methods: ['GET'] },
  ...
  { path: '/api/v1/planner-runs', methods: ['GET'] },
  ...
  { path: '/api/v1/providers/:providerId/models/refresh', methods: ['POST'] },
  { path: '/api/v1/providers/:providerId/test', methods: ['POST'] },
  { path: '/api/v1/providers/probe-models', methods: ['POST'] },
  ...
  { path: '/api/v1/sessions/:sessionId/cancel-active-run', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/children', methods: ['GET'] },
  { path: '/api/v1/sessions/:sessionId/children/:childSessionId/cancel', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/children/:childSessionId/resume', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/files', methods: ['GET', 'POST'] },
  { path: '/api/v1/sessions/:sessionId/messages', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/model', methods: ['PATCH'] },
  { path: '/api/v1/sessions/:sessionId/reasoning-depth', methods: ['PATCH'] },
  ...
  { path: '/api/v1/skills/:skillId', methods: ['GET'] },
  ...
  { path: '/api/v1/workdirs/:workdirId/files', methods: ['DELETE', 'GET', 'PATCH', 'PUT'] },
  { path: '/api/v1/workdirs/:workdirId/files/download', methods: ['GET'] },
  { path: '/api/v1/workdirs/:workdirId/files/upload', methods: ['POST'] },
  { path: '/api/v1/workdirs/:workdirId/dirs', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/workdir', methods: ['DELETE', 'GET', 'PUT'] },
  { path: '/api/v1/sessions/:sessionId/todos', methods: ['GET', 'POST'] },
  { path: '/api/v1/sessions/:sessionId/todos/:todoId', methods: ['DELETE', 'PATCH'] },
  { path: '/api/v1/sessions/:sessionId/browser/status', methods: ['GET'] },
  { path: '/api/v1/sessions/:sessionId/browser/frame/stream', methods: ['GET'] },
  { path: '/api/v1/sessions/:sessionId/browser/takeover', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/browser/input', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/browser/release', methods: ['POST'] },
  { path: '/api/v1/sessions/:sessionId/browser/agent-request-takeover', methods: ['POST'] },
  { path: '/api/v1/messaging/:provider/:connectorInstanceId/webhook', methods: ['POST'] },
]
