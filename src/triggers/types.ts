 ...
 */
export type WaitConditionType = 'operation_completion' | 'timeout' | 'event'
...
export interface ScheduleTriggerDefinition extends Omit<
  RegisterTriggerInput,
  'triggerType' | 'conditionType' | 'conditionPattern' | 'metadata'
> {
  intervalMs: number
  nextRunAt: string
  metadata?: Record<string, unknown>
