...
const researchProcessor: SubagentDefinition = {
  ...
  allowedSkillIds: ['artifact_workflow', 'documentation_search', 'web_research_guidance', 'memory_research'],
  defaultMaxIterations: 10,
  defaultTimeoutMs: 180_000,
  supportedExecutionModes: ['sync', 'background'],
  canRunInBackground: true,
...
const searchProcessor: SubagentDefinition = {
  ...
  allowedSkillIds: ['documentation_search', 'web_research_guidance'],
