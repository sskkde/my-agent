...
export function projectBundleToData(bundle: ContextBundle): ContextBundleData {
  return {
    ...
    planView: bundle.planView
      ? formatPlanView(bundle.planView)
      : undefined,
    workflowStepView: bundle.workflowStepView
      ? formatWorkflowStepView(bundle.workflowStepView)
      : undefined,
    backgroundRunView: bundle.backgroundRunView
      ? formatBackgroundRunView(bundle.backgroundRunView)
      : undefined,
    triggerView: bundle.triggerView
      ? formatTriggerView(bundle.triggerView)
      : undefined,
  };
}
