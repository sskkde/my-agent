 ...
 */
const APPROVAL_REQUIRED_CATEGORIES: Set<ToolCategory> = new Set([
  'write',
  'delete',
  'send',
  'execute',
 ...
 */
export function determineExposureLevel(
 ...
 */
export function determineSchemaMode(
  exposureLevel: ExposureLevel,
  riskLevel: ToolRiskLevel
): SchemaMode {
 ...
 */
export function createToolExposurePlans(
