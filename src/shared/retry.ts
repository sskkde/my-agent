...
const RECOVERABLE_AUTO_CATEGORIES: RuntimeErrorCategory[] = ['tool_validation_error', 'context_overflow']

const RECOVERABLE_WITH_USER_CATEGORIES: RuntimeErrorCategory[] = ['user_input_error']
...
export function isRetryable(error: RuntimeError): boolean {
  const retryableRecoverabilities: Recoverability[] = ['retryable_later', 'recoverable_auto']
