...
export interface ConnectorRuntimeConfig {
  connectorStore: {
    ...
    updateInstance(id: string, data: Partial<Omit<StoreConnectorInstance, 'id' | 'createdAt' | 'updatedAt'>>): StoreConnectorInstance | undefined;
  };
...
export interface ConnectorAdapter {
  execute(
    instance: StoreConnectorInstance,
