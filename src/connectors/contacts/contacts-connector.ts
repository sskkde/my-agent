...
export class GooglePeopleApiTransport implements ContactsTransport {
  ...
  async validateAuth(): Promise<boolean> {
    try {
      await this.httpTransport.get<{ person: { resourceName: string } }>(
        '/people/me',
        { personFields: 'names' }
      );
      return true;
  ...
  async listContacts(params: ListContactsParams): Promise<ListContactsResponse> {
    ...
    const response = await this.httpTransport.get<GooglePeopleListResponse>(
  ...
  async getContact(params: GetContactParams): Promise<Contact | null> {
    try {
      ...
      const response = await this.httpTransport.get<GooglePeopleListResponse['connections'] extends (infer T)[] | undefined ? T : never>(
        `/${params.resourceName}`,
        queryParams
      );
  ...
  async createContact(params: CreateContactParams): Promise<Contact> {
    ...
    const response = await this.httpTransport.post<GooglePeopleListResponse['connections'] extends (infer T)[] | undefined ? T : never>(
  ...
  async searchContacts(params: SearchContactsParams): Promise<SearchContactsResponse> {
    ...
    const response = await this.httpTransport.get<GooglePeopleSearchResponse>(
