...
import { createLongTermMemoryExtractorService, type ExtractionResult } from './long-term-memory-extractor-service.js'
...
async function executeExtraction(deps: SchedulerDeps, input: ScheduleInput): Promise<ExtractionResult> {
...
export function createLongTermMemoryScheduler(deps: SchedulerDeps): LongTermMemoryScheduler {
