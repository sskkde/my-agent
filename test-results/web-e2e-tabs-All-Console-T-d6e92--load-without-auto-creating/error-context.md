...
- Name: web/e2e/tabs.spec.ts >> All Console Tabs Navigation >> session-console shows session list on load without auto-creating
- Location: web/e2e/tabs.spec.ts:217:3
