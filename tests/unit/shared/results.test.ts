...
import type { SyntheticToolResult, SyntheticToolStatus } from '../../../src/shared/results'
import { SYNTHETIC_TOOL_STATUSES, INTERRUPT_BEHAVIORS } from '../../../src/shared/results'

describe('Results Contracts', () => {
  describe('SyntheticToolStatus', () => {
    it('should accept all documented synthetic tool statuses', () => {
      const statuses: SyntheticToolStatus[] = ['cancelled', 'aborted', 'timeout']
