...
import { createLLMAdapter, createCircuitBreaker, DEFAULT_ADAPTER_CONFIG } from '../../../src/llm'
import type {
  LLMAdapterConfig,
  LLMProvider,
  LLMRequest,
...
describe('LLM Adapter Contracts', () => {
  ...
  describe('Timeout Behavior', () => {
    it('should respect provider-specific timeout configuration', async () => {
      const provider = new FakeLLMProvider('test', createTestProviderConfig({ id: 'test', timeoutMs: 5000 }))
