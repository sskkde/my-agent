...
describe('stableToolSort', () => {
  ...
  it('should sort by category then name', () => {
    const tools = [
      createTool('z_read', 'read'),
      createTool('a_write', 'write'),
      createTool('a_read', 'read'),
    ];
  ...
  it('should sort read before write', () => {
    const tools = [
      createTool('write', 'write'),
      createTool('read', 'read'),
    ];
  ...
  it('should sort search category correctly', () => {
    const tools = [
      createTool('execute', 'execute'),
      createTool('search', 'search'),
      createTool('read', 'read'),
    ];
