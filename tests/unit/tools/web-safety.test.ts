...
describe('web-safety', () => {
  ...
  describe('Redirect Safety', () => {
    it('should validate redirect URLs', () => {
      const result = validateRedirectSafety('https://example.com/', 'https://redirect.com/')
    ...
    it('should reject redirects to blocked IPs', () => {
      const result = validateRedirectSafety('https://example.com/', 'http://127.0.0.1/')
    ...
    it('should reject redirects to localhost', () => {
      const result = validateRedirectSafety('https://example.com/', 'http://localhost/')
    ...
    it('should reject redirects to blocked protocols', () => {
      const result = validateRedirectSafety('https://example.com/', 'file:///etc/passwd')
