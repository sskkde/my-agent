...
import {
  ...
  type FileApplyPatchParams,
  type FileApplyPatchResult,
} from '../../../src/tools/builtins/file-apply-patch.js'
...
describe('file_apply_patch tool', () => {
  ...
  it('should add a new file', async () => {
    const operations: FilePatchOperation[] = [{ type: 'add', filePath: 'new.txt', content: 'created' }]
  ...
  it('should delete a file', async () => {
    ...
    const operations: FilePatchOperation[] = [{ type: 'delete', filePath: 'old.txt' }]
