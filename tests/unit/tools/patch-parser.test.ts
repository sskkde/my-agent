...
import { parsePatchText, validateOperations, type FilePatchOperation } from '../../../src/tools/builtins/patch-parser.js';
  ...
  describe('validateOperations', () => {
    it('should validate correct add operation', () => {
      const ops: FilePatchOperation[] = [
        { type: 'add', filePath: 'new.txt', content: 'content' },
      ];
    ...
    it('should reject add operation with oldString', () => {
      const ops: FilePatchOperation[] = [
        { type: 'add', filePath: 'new.txt', content: 'content', oldString: 'old' },
      ];
    ...
    it('should validate correct update operation', () => {
      const ops: FilePatchOperation[] = [
        { type: 'update', filePath: 'file.txt', oldString: 'old', newString: 'new' },
      ];
    ...
    it('should reject update operation without oldString', () => {
      const ops: FilePatchOperation[] = [
        { type: 'update', filePath: 'file.txt', newString: 'new' },
      ];
    ...
    it('should reject update operation without newString', () => {
      const ops: FilePatchOperation[] = [
        { type: 'update', filePath: 'file.txt', oldString: 'old' },
      ];
    ...
    it('should reject delete operation with content', () => {
      const ops: FilePatchOperation[] = [
        { type: 'delete', filePath: 'old.txt', content: 'content' },
      ];
