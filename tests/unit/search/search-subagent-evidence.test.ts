  ...
  return {
    searchSubagent: {
      execute: vi.fn().mockResolvedValue({
        ...
        toolResult: {
          query: 'test query',
          results: [{ title: 'Result 1', url: 'https://example.com/page1', snippet: 'Snippet 1' }],
          total: 1,
          provider: 'searxng',
...
describe('SearchSubagent Evidence Tests', () => {
        ...
        searchSubagent: {
          execute: vi.fn().mockResolvedValue({
            ...
            toolResult: {
              ...
              results: [{ title: 'AI Breakthrough', url: 'https://news.com/ai', snippet: 'New AI model released' }],
              total: 1,
              provider: 'searxng',
              endpointHost: 'localhost:8888',
            },
              ...
              results: [
                {
                  ...
                  snippet: 'Published on 2026-06-03: New AI model released',
                },
              ],
              total: 1,
              provider: 'searxng',
  ...
  describe('Fact Extraction', () => {
    ...
    it('each fact has confidence score', async () => {
      ...
      const results = [{ title: 'Test', url: 'https://example.com', snippet: 'This is a fact. Another fact here.' }]
