...
describe('Summary Prompt Builder', () => {
  ...
  describe('buildSessionSummaryPrompt', () => {
    it('should build prompt with hardcoded fallback when P0 disabled', async () => {
      ...
      const { buildSessionSummaryPrompt: buildPrompt } = await import(
        '../../../src/memory/summary-prompt-builder.js'
      );
  ...
  describe('buildDailySummaryPrompt', () => {
    it('should build prompt with hardcoded fallback when P0 disabled', async () => {
      ...
      const { buildDailySummaryPrompt: buildPrompt } = await import(
        '../../../src/memory/summary-prompt-builder.js'
      );
  ...
  describe('buildWeeklySummaryPrompt', () => {
    it('should build prompt with hardcoded fallback when P0 disabled', async () => {
      ...
      const { buildWeeklySummaryPrompt: buildPrompt } = await import(
        '../../../src/memory/summary-prompt-builder.js'
      );
  ...
  describe('buildLongTermProfilePrompt', () => {
    it('should build prompt with hardcoded fallback when P0 disabled', async () => {
      ...
      const { buildLongTermProfilePrompt: buildPrompt } = await import(
        '../../../src/memory/summary-prompt-builder.js'
      );
  ...
  describe('buildAtomicFactsPrompt', () => {
    it('should build prompt with hardcoded fallback when P0 disabled', async () => {
      ...
      const { buildAtomicFactsPrompt: buildPrompt } = await import(
        '../../../src/memory/summary-prompt-builder.js'
      );
