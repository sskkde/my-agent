...
describe('applyLifecyclePolicy', () => {
  ...
  describe('score_only phase', () => {
    it('score_only never transitions', () => {
      const memory = makeMemory({ lifecycle: { status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' } });
      const score = { score: 0.2, recommendation: 'archive_candidate' as const, breakdown: { recency: 0.1, frequency: 0.1, importance: 0.25, relevance: 0.5 } };
  ...
  describe('low_priority_only phase', () => {
    ...
    it('low_priority_only does not touch active memories', () => {
      const memory = makeMemory({ lifecycle: { status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' } });
      const score = { score: 0.8, recommendation: 'active' as const, breakdown: { recency: 1.0, frequency: 0.9, importance: 1.0, relevance: 0.5 } };
    ...
    it('low_priority_only does not touch low_priority recommendation', () => {
      const memory = makeMemory({ lifecycle: { status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' } });
      const score = { score: 0.4, recommendation: 'low_priority' as const, breakdown: { recency: 0.5, frequency: 0.5, importance: 0.5, relevance: 0.5 } };
    ...
    it('low_priority_only requires score < 0.3 for archive_candidate transition', () => {
      const memory = makeMemory({ lifecycle: { status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' } });
      const score = { score: 0.299, recommendation: 'archive_candidate' as const, breakdown: { recency: 0.1, frequency: 0.1, importance: 0.25, relevance: 0.5 } };
    ...
    it('low_priority_only does not transition archive_candidate with score >= 0.3', () => {
      const memory = makeMemory({ lifecycle: { status: 'active', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' } });
      const score = { score: 0.3, recommendation: 'archive_candidate' as const, breakdown: { recency: 0.3, frequency: 0.3, importance: 0.3, relevance: 0.3 } };
