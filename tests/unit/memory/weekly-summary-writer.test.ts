...
describe('writeWeeklySummary', () => {
  ...
  describe('sourceRefs validation', () => {
    it('should reject write with empty sourceRefs (MISSING_SOURCE_REFS)', async () => {
      ...
      const result = await manager.writeWeeklySummary('user-123', content, { sourceRefs: {} as never })
    ...
    it('should reject write with missing sourceRefs', async () => {
      ...
      const result = await manager.writeWeeklySummary('user-123', content, { sourceRefs: undefined as never })
    ...
    it('should accept write with valid transcriptRefs', async () => {
      ...
      const result = await manager.writeWeeklySummary('user-123', content, {
