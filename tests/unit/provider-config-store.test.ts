...
describe('provider-config-store', () => {
  ...
  describe('malformed JSON fallback', () => {
    it('should handle malformed JSON in headers_json safely', () => {
      ...
      connection.exec("UPDATE provider_configs SET headers_json = '{invalid json' WHERE provider_id = ?", [
        'prov-malformed-001',
      ])
    ...
    it('should handle malformed JSON in capabilities_json safely', () => {
      ...
      connection.exec("UPDATE provider_configs SET capabilities_json = 'not valid json' WHERE provider_id = ?", [
        'prov-malformed-002',
      ])
    ...
    it('should handle malformed JSON in models_json safely', () => {
      ...
      connection.exec("UPDATE provider_configs SET models_json = '[{broken' WHERE provider_id = ?", [
        'prov-malformed-003',
      ])
    ...
    it('should handle malformed JSON in options_json safely', () => {
      ...
      connection.exec("UPDATE provider_configs SET options_json = '{{}}' WHERE provider_id = ?", ['prov-malformed-004'])
