...
import { V1_PREFIX, withV1Prefix, createLegacyRedirect, ROUTE_MAP } from '../../../src/api/v1-prefix.js'
  ...
  describe('ROUTE_MAP', () => {
    ...
    it('should have all 24 route modules covered', () => {
      ...
      for (const category of routeCategories) {
        const hasCategoryRoute = Object.keys(ROUTE_MAP).some((route) => route.includes(category))
