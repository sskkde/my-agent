...
describe('OAuthCallbackHandler', () => {
  ...
  describe('handleCallback', () => {
    ...
    it('should return INVALID_STATE for non-existent state', async () => {
      const result = await handler.handleCallback(testConfig, 'auth-code', 'non-existent-state-id', 'some-verifier')
    ...
    it('should return INVALID_STATE for already consumed state (replay attack)', async () => {
      ...
      await handler.handleCallback(testConfig, 'auth-code', authRequest.stateId, authRequest.codeVerifier)
    ...
    it('should return PKCE_MISMATCH for wrong code_verifier', async () => {
      ...
      const result = await handler.handleCallback(testConfig, 'auth-code', authRequest.stateId, 'wrong-code-verifier')
