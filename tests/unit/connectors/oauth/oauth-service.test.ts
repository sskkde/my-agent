...
describe('OAuthService', () => {
  ...
  describe('generateAuthorizationUrl', () => {
    ...
    it('should include all scopes', () => {
      ...
      expect(result.authorizeUrl).toContain('scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcalendar.readonly')
    })
  ...
  describe('exchangeCode', () => {
    it('should throw on HTTP error', async () => {
      ...
      await expect(service.exchangeCode(testConfig, 'auth-code', 'state-id', 'verifier')).rejects.toThrow(
    ...
    it('should return token data on success', async () => {
      ...
      const result = await service.exchangeCode(testConfig, 'auth-code', 'state-id', 'verifier')
  ...
  describe('refreshAccessToken', () => {
    it('should throw on HTTP error', async () => {
      ...
      await expect(service.refreshAccessToken(testConfig, 'expired-refresh-token')).rejects.toThrow(
        'Token refresh failed: 401 invalid_token',
      )
