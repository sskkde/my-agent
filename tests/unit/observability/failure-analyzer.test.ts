  ...
  describe('getHighestSeverity', () => {
    it('should return critical from mixed severities', () => {
      const analyses: FailureAnalysis[] = [
        { rootCause: 'low', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'low', category: 'unknown' },
        { rootCause: 'high', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'high', category: 'unknown' },
        { rootCause: 'critical', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'critical', category: 'unknown' },
      ];
    ...
    it('should return high from low and medium', () => {
      const analyses: FailureAnalysis[] = [
        { rootCause: 'low', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'low', category: 'unknown' },
        { rootCause: 'medium', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'medium', category: 'unknown' },
        { rootCause: 'high', contributingEvents: [], suggestedFixes: [], retryable: true, severity: 'high', category: 'unknown' },
      ];
