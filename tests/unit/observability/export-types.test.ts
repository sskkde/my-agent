...
describe('Export Types', () => {
  ...
  describe('Alerting Types', () => {
    ...
    it('should support all severity levels', () => {
      const critical: AlertRule = { id: '1', name: 'c', condition: 'c', threshold: 1, windowSeconds: 60, severity: 'critical', channels: [] };
      const warning: AlertRule = { id: '2', name: 'w', condition: 'w', threshold: 1, windowSeconds: 60, severity: 'warning', channels: [] };
      const info: AlertRule = { id: '3', name: 'i', condition: 'i', threshold: 1, windowSeconds: 60, severity: 'info', channels: [] };
