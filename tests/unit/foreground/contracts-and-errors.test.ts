...
import type { ForegroundTurnInput, ForegroundTurnResult, ToolCallSummary } from '../../../src/foreground/foreground-runner-types.js';
  ...
  describe('Required fields', () => {
    ...
    it('should require foregroundState field', () => {
      const input: ForegroundTurnInput = {
        ...
        timestamp: '2024-01-01T00:00:00Z',
        hydratedState: {} as any,
        foregroundState: { hydratedSession: {} as any, activeWorkRefs: {} as any, currentPersona: {} as any, effectivePolicy: {} as any } as any,
      };
...
describe('buildForegroundToolProjection', () => {
  ...
  describe('Safe defaults', () => {
    ...
    it('should include tools with medium sensitivity in safe categories', () => {
      const tools = [
        ...
        createTool('web_search', 'search', 'medium'),
      ];
  ...
  describe('High-risk exclusion', () => {
    it('should exclude write category tools by default', () => {
      const tools = [
        createTool('file_write', 'write', 'low'),
        createTool('file_read', 'read', 'low'),
      ];
    ...
    it('should exclude delete category tools by default', () => {
      const tools = [
        createTool('file_delete', 'delete', 'low'),
        createTool('file_read', 'read', 'low'),
      ];
    ...
    it('should exclude execute category tools by default', () => {
      const tools = [
        createTool('run_command', 'execute', 'low'),
        createTool('status_query', 'internal', 'low'),
      ];
    ...
    it('should exclude admin category tools by default', () => {
      const tools = [
        createTool('configure_system', 'admin', 'low'),
        createTool('web_search', 'search', 'low'),
      ];
    ...
    it('should exclude tools with high sensitivity even in safe categories', () => {
      const tools = [
        createTool('sensitive_search', 'search', 'high'),
        createTool('normal_search', 'search', 'low'),
      ];
    ...
    it('should exclude tools with restricted sensitivity', () => {
      const tools = [
        ...
        createTool('normal_tool', 'read', 'low'),
      ];
