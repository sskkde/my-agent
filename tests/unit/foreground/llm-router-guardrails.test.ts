 ...
 */
const KNOWN_TOOL_IDS: string[] = getFallbackToolCatalog().map((entry) => entry.name)
...
describe('LLM Router Guardrails', () => {
  ...
  describe('Tool Filtering', () => {
    ...
    it('should filter tools against AgentConfig allowlist', () => {
      ...
      const allowedToolIds =
        agentConfig.allowedToolIds === null || agentConfig.allowedToolIds === undefined
          ? KNOWN_TOOL_IDS
  ...
  describe('Skill Filtering', () => {
    ...
    it('should filter skills against AgentConfig allowlist', () => {
      ...
      const allowedSkillIds =
        agentConfig.allowedSkillIds === null || agentConfig.allowedSkillIds === undefined
          ? KNOWN_SKILL_IDS
  ...
  describe('Known Catalog Validation', () => {
    ...
    it('should only accept skills from known catalog', () => {
      const suggestedSkills = ['artifact_create', 'malicious_skill', 'memory_retrieve']
  ...
  describe('Intersection Logic', () => {
    it('should perform three-way intersection: suggested ∩ allowed ∩ known', () => {
      ...
      const suggestedTools = ['docs_search', 'memory_retrieve', 'plan_patch', 'hallucinated.tool', 'artifact_create']
  ...
  describe('Edge Cases', () => {
    it('should handle null AgentConfig gracefully (all known tools)', () => {
      ...
      const allowedToolIds: string[] =
        cfg?.allowedToolIds === null || cfg?.allowedToolIds === undefined ? KNOWN_TOOL_IDS : cfg.allowedToolIds
