  ...
  describe('Turn with approval summaries', () => {
    ...
    beforeAll(() => {
      const turn: TurnTranscript = {
        ...
        runtimeSummary: {
          approvalSummaries: ['Approval requested: Delete database prod-db (HIGH RISK)'],
        },
        visibility: 'public',
  ...
  describe('Event type filtering', () => {
    ...
    beforeAll(() => {
      const turn: TurnTranscript = {
        ...
        output: {
          visibleMessages: [{ messageId: 'msg-filter-001', role: 'assistant', content: 'Assistant response' }],
        },
        runtimeSummary: {
  ...
  describe('Old transcript compatibility (EC-8)', () => {
    ...
    beforeAll(() => {
      ...
      const turnWithAckMessages: TurnTranscript = {
        ...
        output: {
          visibleMessages: [{ messageId: 'msg-ack-001', role: 'approval', content: 'Approval granted for action' }],
        },
        runtimeSummary: {
  ...
  describe('Complex session with multiple turns', () => {
    ...
    beforeAll(() => {
      const turn1: TurnTranscript = {
        ...
        output: {
          visibleMessages: [{ messageId: 'msg-c001', role: 'assistant', content: 'First response' }],
        },
        visibility: 'public',
      ...
      const turn2: TurnTranscript = {
        ...
        output: {
          visibleMessages: [{ messageId: 'msg-c002', role: 'assistant', content: 'Second response' }],
        },
        runtimeSummary: {
