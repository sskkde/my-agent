...
class MockArtifactStore implements ArtifactStore {
  ...
  findByArtifactId() { return undefined; }
  findById() { return undefined; }
  findByUserId() { return []; }
  findBySessionId() { return []; }
  findByType() { return []; }
  findByStatus() { return []; }
...
class MockSummaryStore implements SummaryStore {
  save() {}
  getBySummaryId() { return null; }
  getByType() { return []; }
  getWorkingSummary() { return null; }
  getSessionMemory() { return null; }
  applyPatch() { return {} as any; }
}

class MockTranscriptStore implements TranscriptStore {
  saveTurn() { return true; }
  getTurn() { return null; }
  findBySession() { return []; }
  search() { return []; }
  findByArtifactRef() { return []; }
  findByPlannerRunId() { return []; }
  updateUserIdForSession() { return 0; }
}

class MockPlanStore implements PlanStore {
  createPlan() { return {} as any; }
  getPlan() { return null; }
  applyPatch() { return {} as any; }
  getPatches() { return []; }
  findByObjectiveHash() { return []; }
  updateStepStatus() {}
}
...
class MockToolResultStore implements ToolResultStore {
  create() { return {} as any; }
  findById() { return undefined; }
  findByToolCallId() { return []; }
  findBySessionId() { return []; }
  findByToolName() { return []; }
  findBySensitivity() { return []; }
  delete() { return false; }
  applyMigrations() {}
}
...
class MockLongTermMemoryStore implements LongTermMemoryStore {
  save() {}
  getByMemoryId() { return null; }
  getByUserId() { return []; }
  getByType() { return []; }
  search() { return []; }
  delete() {}
  applyPatch() { return {} as any; }
  findCurrentByFingerprint() { return null; }
  upsertExtracted() {}
  createTombstone() {}
  hasTombstone() { return false; }
  getTombstone() { return null; }
  hasTombstoneForSource() { return false; }
  searchActive() { return []; }
  getByEntityName() { return []; }
  getByDateRange() { return []; }
}
...
class MockSessionStore implements SessionStore {
  ...
  getById() { return null; }
  list() { return []; }
  updateActivity() { return false; }
  updateMetadata() { return false; }
  updateStatus() { return false; }
  updateTitle() { return false; }
  updateUserId() { return false; }
