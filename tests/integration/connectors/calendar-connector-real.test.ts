...
describe('Calendar Connector Integration', () => {
  ...
  describe('Capability Discovery', () => {
    ...
    it('should classify write operations as medium risk', () => {
      ...
      const writeCapabilities = capabilities.filter(
        (c) => c.capabilityId === 'calendar.create_event' || c.capabilityId === 'calendar.update_event',
      )
    ...
    it('should classify delete as high risk', () => {
      ...
      const deleteCapability = capabilities.find((c) => c.capabilityId === 'calendar.delete_event')
