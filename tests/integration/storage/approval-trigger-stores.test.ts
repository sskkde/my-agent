  ...
  describe('WaitCondition Store', () => {
    ...
    describe('findExpired', () => {
      it('should find expired wait conditions', () => {
        ...
        waitConditionStore.create(createTestWaitCondition({ timeoutAt: pastDate, status: WAIT_CONDITION_STATES.ACTIVE }));
        waitConditionStore.create(createTestWaitCondition({ timeoutAt: futureDate, status: WAIT_CONDITION_STATES.ACTIVE }));
